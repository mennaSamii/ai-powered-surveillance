...
from HumanFallDetection.Actionsrecognition.Models import TwoStreamSpatialTemporalGraph
from HumanFallDetection.pose_utils import normalize_points_with_size, scale_pose
...
class TSSTG(object):
    ...
    """
    def __init__(self,
                 weight_file='./HumanFallDetection/Models/TSSTG/tsstg-model.pth',
                 device='cuda'):
