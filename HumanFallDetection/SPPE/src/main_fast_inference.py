...
import numpy as np
from HumanFallDetection.SPPE.src.utils.img import flip, shuffleLR
from HumanFallDetection.SPPE.src.utils.eval import getPrediction
from HumanFallDetection.SPPE.src.models.FastPose import FastPose
...
class InferenNet_fastRes50(nn.Module):
    def __init__(self, weights_file='./HumanFallDetection/Models/sppe/fast_res50_256x192.pth'):
        super().__init__()
