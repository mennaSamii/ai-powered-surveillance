from HumanFallDetection.SPPE.src.opt import opt
try:
    from utils import transformBoxInvert, transformBoxInvert_batch, findPeak, processPeaks
except ImportError:
    from HumanFallDetection.SPPE.src.utils.img import transformBoxInvert, transformBoxInvert_batch, findPeak, processPeaks
import torch
