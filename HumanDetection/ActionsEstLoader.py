...
from HumanDetection.Actionsrecognition.Models import TwoStreamSpatialTemporalGraph
from HumanDetection.pose_utils import normalize_points_with_size, scale_pose
...
class TSSTG(object):
    ...
    """
    def __init__(self,
                 weight_file='./HumanDetection/Models/TSSTG/tsstg-model.pth',
                 device='cuda'):
