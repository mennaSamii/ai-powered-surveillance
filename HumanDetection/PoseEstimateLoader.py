...
from HumanDetection.SPPE.src.main_fast_inference import InferenNet_fast, InferenNet_fastRes50
from HumanDetection.SPPE.src.utils.img import crop_dets
from HumanDetection.pPose_nms import pose_nms
