...
save_path = 'F://AISS_project//data/trail-pose+score.csv'

annot_file = 'F://AISS_project//data//trail.csv'  # from create_dataset_1.py
video_folder = 'F://trail_for_dataset_3//Videos'
annot_folder = 'F://trail_for_dataset_3//Annotation_files'  # bounding box annotation for each frame.
...
for vid in vid_list:
    ...
    index=index+1
    annot=annot_or    
    print ("processing video num ", index)
    print (annot)
    # Pose Labels.
