...
save_path = 'D:/AISS_project/data/Home_new-pose+score.csv'

annot_file = 'D:/AISS_project/data/Home_new.csv'  # from create_dataset_1.py
video_folder = 'E:/Coffee_room_02/Coffee_room_02/Videos'
annot_folder = 'E:/Coffee_room_02/Coffee_room_02/Annotations_files'  # bounding box annotation for each frame.
