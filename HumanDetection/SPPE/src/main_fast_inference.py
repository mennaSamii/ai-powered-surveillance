...
import numpy as np
from HumanDetection.SPPE.src.utils.img import flip, shuffleLR
from HumanDetection.SPPE.src.utils.eval import getPrediction
from HumanDetection.SPPE.src.models.FastPose import FastPose
...
class InferenNet_fastRes50(nn.Module):
    def __init__(self, weights_file='./HumanDetection/Models/sppe/fast_res50_256x192.pth'):
        super().__init__()
