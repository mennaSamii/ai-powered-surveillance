from HumanDetection.SPPE.src.opt import opt
try:
    from utils import transformBoxInvert, transformBoxInvert_batch, findPeak, processPeaks
except ImportError:
    from HumanDetection.SPPE.src.utils.img import transformBoxInvert, transformBoxInvert_batch, findPeak, processPeaks
import torch
