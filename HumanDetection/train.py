...
from Actionsrecognition.Models import StreamSpatialTemporalGraph,GraphConvolution,st_gcn,TwoStreamSpatialTemporalGraph
...
data_files = ['F://AISS_project//data//trail1-set(labelXscrw).pkl']
